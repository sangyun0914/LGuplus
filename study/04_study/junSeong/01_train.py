    ...
    def read_data_set(self):
        ...
        for index, class_name in enumerate(class_names):
            ...
            for img_file in img_files:
                ...
                if (img_file == './data/train/Lunge/.DS_Store'):
                    continue
                if (img_file == './data/train/Lying/.DS_Store'):
                    continue
                if (img_file == './data/train/Pushup/.DS_Store'):
                    continue
...
for e in range(hyper_param_epoch):
    for i_batch, item in enumerate(train_loader):
        ...
        if (i_batch + 1) % hyper_param_batch == 1:
            print('Epoch [{}/{}], Loss: {:.4f}'
...
torch.save(custom_model.state_dict(), "modelv4.pt")