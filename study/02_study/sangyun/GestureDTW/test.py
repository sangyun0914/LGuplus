...
# Turn on the webcam
cap = cv2.VideoCapture("study/02_study/sangyun/GestureDTW/data/videos/Left/Left-F.mp4")
...
with mp.solutions.holistic.Holistic(
    ...
    while cap.isOpened():
        ...
        cv2.putText(frame, f'Left: Red', (20,70), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 3)
        cv2.putText(frame, f'Right: Green', (20,100), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 249, 161), 3)
